...
GetAllFormsResponseModel1 getAllFormsResponseModelFromJson(String str) =>
    GetAllFormsResponseModel1.fromJson(json.decode(str));

String getAllFormsResponseModelToJson(GetAllFormsResponseModel1 data) =>
    json.encode(data.toJson());

class GetAllFormsResponseModel1 {
  String status;
  String message;
  List<Datum> data;

  GetAllFormsResponseModel1({
    required this.status,
    required this.message,
    required this.data,
  });

  factory GetAllFormsResponseModel1.fromJson(Map<String, dynamic> json) =>
      GetAllFormsResponseModel1(
        status: json["status"],
