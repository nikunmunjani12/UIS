...
GetSingleResponseModel notificationModelFromJson(String str) =>
    GetSingleResponseModel.fromJson(json.decode(str));

String notificationModelToJson(GetSingleResponseModel data) =>
...
class GetSingleResponseModel {
  ...
  factory GetSingleResponseModel.fromJson(Map<String, dynamic> json) =>
      GetSingleResponseModel(
        status: json["status"],
